        ...
        <div class="right">
            ...
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="visitor_name"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="company_name" name="visitor_company"
                           ...
                           placeholder="Jan Willem BV" pattern=[A-Z\sa-z]{2,25} required>
                </div>
                <div class="form-group">
                    <label for="postal_code"
                           class="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Postcode:</label>
                    <input type="text" id="postal_code" name="visitor_postalcode"
                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phone_number" name="visitor_phonenumber"
                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                           placeholder="06 12345678" pattern=[0-9]{3}-[0-9]{3}-[0-9]{4} required>
                </div>
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="visitor_email"
                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                           placeholder="janwillem@email.com" required>
                </div>
                <div class="form-group">
                    <label for="title"
                           class="block mb-2 text-sm font-medium text-black-900 dark:text-black-300">Titel:</label>
                    <input type="text" id="title" name="visitor_title"
                           class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                           placeholder="Huren van koffiemachine" pattern=[A-Z\sa-z]{3,20} required>
                </div>
                <div class="form-group">
